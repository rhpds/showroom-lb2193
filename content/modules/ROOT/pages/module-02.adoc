...
// TODO - Make this a bit clearer. Are people having to add stuff to their vault? if so we should probably just say that. Let's revisit this and clarify what our intentions are
...
Add to file `group_vars/all/inventories.yml` and a new varible with the
...
// TODO - explain the intention of what we are doing here
