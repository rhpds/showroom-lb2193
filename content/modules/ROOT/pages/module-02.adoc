...
- Create a file `/home/lab-user/casc_lab/group_vars/all/credential_types.yml` where we will
...
- Create a file `/home/lab-user/casc_lab/group_vars/all/credentials.yml` and add the required
